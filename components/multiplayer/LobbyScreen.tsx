    ...
    <div className={`lobby-overlay ${lobbyVisible ? 'is-visible' : 'is-hidden'}`} aria-hidden={!lobbyVisible}>
      ...
      <div className="lobby-bottom-bar">
         <div style={{ display: 'flex', gap: '15px' }}>
            <a href="https://x.com/ansemshouse" target="_blank" rel="noreferrer" style={{ textDecoration: 'none' }}>
            ...
            <a href="https://pump.fun/coin/2ejHHqpgQUVeFCBXNB5sH8RdVC9BGeKP4MkAgc6Zpump" target="_blank" rel="noreferrer" style={{ textDecoration: 'none' }}>
