...
Copied identically from playroom_guide/src/components/CharacterSoldier.jsx
*/
...
export function CharacterSoldier({
  ...
  const group = useRef();
  const { scene, materials, animations: soldierAnimations } = useGLTF(
  ...
  const { actions } = useAnimations(soldierAnimations, group);
  ...
  useEffect(() => {
    ...
    if (!action) {
      // console.warn('[CharacterSoldier] Animation not found:', animation, Object.keys(actions || {}))
      return
    }
